#!/usr/bin/env python3
"""
Teste do bilhete 22ove2 via API (múltiplas apostas)
"""
...
BET_CODE = "22ove2"  # Bilhete com múltiplas apostas

def test_api_22ove2():
    """Tests the /api/capture-bet endpoint with bilhete 22ove2"""

    print("🧪 TESTE DO BILHETE 22OVE2 (MÚLTIPLAS APOSTAS)")
    print("=" * 60)
