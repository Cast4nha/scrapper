#!/usr/bin/env python3
"""
Teste específico para o bilhete 22ove2 (múltiplas apostas no mesmo jogo)
"""
...
def test_22ove2():
    """Testa o bilhete 22ove2 com múltiplas apostas"""
    
    print("🧪 TESTE ESPECÍFICO - BILHETE 22OVE2 (MÚLTIPLAS APOSTAS)")
    print("=" * 60)
